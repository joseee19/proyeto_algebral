...
class MatrixSubtraction(QWidget):
    def __init__(self):
        super().__init__()
        self.initUI()
    ...
    def initUI(self):
        ...
        self.subtract_button.clicked.connect(self.subtract_matrices)
        self.subtract_button.setDisabled(True)
    ...
    def create_matrices_input(self):
        ...
        self.subtract_button.setDisabled(False)
