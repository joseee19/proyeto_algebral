...
from dot_product import VectoresProductoPunto
...
class VectorWindow(QMainWindow):
    def __init__(self, app):
        ...
        self.vector_dot_product_window = None
    ...
    def initUI(self):
        ...
        vector_product.clicked.connect(self.show_vector_dot_product_window)
    ...
    def show_vector_dot_product_window(self):
        self.setVisible(False)
        self.vector_dot_product_window = VectoresProductoPunto(self)
        self.vector_dot_product_window.show()
